    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/popups/monthly").permitAll()
                        .requestMatchers("/user/login", "/auth/refresh", "/user/join", "/vendor/login", "/vendor/join", "/admin/login", "/auth/**", "/images", "/scan-qr", "/", "/login", "/board/file/**").permitAll() // 로그인/회원가입/토큰 갱신은 허용

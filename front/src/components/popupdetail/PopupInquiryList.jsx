                    ...
                    return (
                        <div key={item.id} className="inquiry-item">
                            ...
                            <div className="item-1">
                                ...
                                {canView && (
                                    <button onClick={() => toggleReplyHandler(item.id)}
                            ...
                            <div className="content">
                                {!canView ? (
                                    <p><img src={"/icon-password-inactive.png"} alt={"secret"}/>비공개 문의입니다.</p>
                                ) : isOpen && (
                                    <div
                            ...
                            {canView && (
                                <div className={`inquiry-replies ${isOpen ? "open" : ""}`}>
                                    {itemReplies.length > 0 ? (
                                        itemReplies.map((rep) => (
                                            <>
                                                <p className={"vendor-name"}><span>관리자</span><span className={"reply-createdAt"}>{new Date(rep.created_at).toLocaleDateString()}</span></p>
                                                <div
                                                    key={rep.id}
